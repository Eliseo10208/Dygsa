...
const CrearCamion = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // await axios.post('/api/camion/crear', formData);
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <div className="group">
              ...
              <input name="clase_vehiculo" type="text" className="form-control" />
            </div>
            <div className="group">
              <div className="label">Nro ejes</div>
              <input name="nro_ejes" type="text" className="form-control" />
            </div>
            <div className="group">
              <div className="label">Año fabricación</div>
              <input name="año_fabricacion" type="text" className="form-control" />
            </div>
            <div className="group">
          ...
          <div className="col-md-6">
            ...
            <div className="group">
              ...
              <input name="pdf_tarjeta_propiedad" type="file" className="form-control" accept=".pdf" onChange={handleFileChange} />
              <div className="status no"></div>
            </div>
